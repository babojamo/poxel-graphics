              ...
              <div class="row">
                ...
                <div class="col-lg-4 me-auto ms-0 text-center">
                  <div class="bg-gradient-primary border-radius-lg min-height-200">
                    <img src="{{ asset('admin/assets/img/shapes/waves-white.svg') }}" class="position-absolute h-100 top-0 d-md-block d-none" alt="waves">
                    <div class="position-relative pt-5 pb-4">
                      <img class="max-width-500 w-100 position-relative z-index-2" src="{{ asset('admin/assets/img/illustrations/rocket-white.png') }}">
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{ asset('admin/assets/img/small-logos/logo-xd.svg') }}" class="avatar avatar-sm ms-3">
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{ asset('admin/assets/img/small-logos/logo-atlassian.svg') }}" class="avatar avatar-sm ms-3">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{ asset('admin/assets/img/small-logos/logo-slack.svg') }}" class="avatar avatar-sm ms-3">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{ asset('admin/assets/img/small-logos/logo-spotify.svg') }}" class="avatar avatar-sm ms-3">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{ asset('admin/assets/img/small-logos/logo-jira.svg') }}" class="avatar avatar-sm ms-3">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{ asset('admin/assets/img/small-logos/logo-invision.svg') }}" class="avatar avatar-sm ms-3">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
